...
class HeatMapBuilder:
    def __init__(self, main_path="Acquisitions_Eye_tracking_objets_visages_Fix_Seq1", heatmap_shape=(64, 64), images_shape=(1000, 1000)):
    ...
    def generate_heatmap(self, group, file_name, sheet_name):
        ...
        heatmap = np.zeros(self.heatmap_shape)
